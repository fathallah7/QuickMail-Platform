...
@section('content')
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm p-6 border-3 border-indigo-600 rounded-2xl">

            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-indigo-600">Sign UP</h2>
            </div>


            <form class="space-y-6" action="{{ route('signupDone') }}" method="POST">
                @csrf
                <div>
                    <label for="email" class="block text-sm/6 font-medium text-gray-900">Your Name</label>
                    <div class="mt-2">
                        <input type="text" name="name" id="name" autocomplete="email" required value="{{old('name')}}"
